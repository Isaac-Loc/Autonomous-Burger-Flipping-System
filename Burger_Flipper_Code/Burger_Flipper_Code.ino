...
#define laser5 52 //Pin for laser 5
#define laser6 53 //Pin for laser 6
...
#define receiver5 40 //Pin for receiver 5
#define receiver6 41 //Pin for receiver 6
...
void setup() {
  ...
  digitalWrite(laser5, HIGH); // emit red laser



  pinMode(laser6, OUTPUT);
  pinMode(receiver6, INPUT); 
  digitalWrite(laser6, HIGH); // emit red laser
...
void loop() {
 ...
 // CheckKillSwitch();
  ...
  int value5 = digitalRead(receiver5);
  int value6 = digitalRead(receiver6);
